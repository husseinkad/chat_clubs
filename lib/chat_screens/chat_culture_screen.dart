...
class ChatCultureScreen extends StatefulWidget {
  const ChatCultureScreen({Key? key}) : super(key: key);

  @override
  _ChatCultureScreenState createState() => _ChatCultureScreenState();
}

class _ChatCultureScreenState extends State<ChatCultureScreen> {
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            _firestore.collection('messagesCulture').add({
...
// }
  ...
  return StreamBuilder<QuerySnapshot>(
    stream: _firestore.collection('messagesCulture').orderBy('time').snapshots(),
