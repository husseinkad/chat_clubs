...
class ChatTechScreen extends StatefulWidget {
  const ChatTechScreen({Key? key}) : super(key: key);

  @override
  _ChatTechScreenState createState() => _ChatTechScreenState();
}

class _ChatTechScreenState extends State<ChatTechScreen> {
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            _firestore.collection('messagesTech').add({
...
// }
  ...
  return StreamBuilder<QuerySnapshot>(
    stream: _firestore.collection('messagesTech').orderBy('time').snapshots(),
