...
class ChatScienceScreen extends StatefulWidget {
  const ChatScienceScreen({Key? key}) : super(key: key);

  @override
  _ChatScienceScreenState createState() => _ChatScienceScreenState();
}

class _ChatScienceScreenState extends State<ChatScienceScreen> {
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            _firestore.collection('messagesScince').add({
...
// }
  ...
  return StreamBuilder<QuerySnapshot>(
    stream: _firestore.collection('messagesScince').orderBy('time').snapshots(),
