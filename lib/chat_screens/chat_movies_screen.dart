...
class ChatMoviesScreen extends StatefulWidget {
  const ChatMoviesScreen({Key? key}) : super(key: key);

  @override
  _ChatMoviesScreenState createState() => _ChatMoviesScreenState();
}

class _ChatMoviesScreenState extends State<ChatMoviesScreen> {
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            ...
                            _firestore.collection('messegesMovies').add({
...
// }
  ...
  return StreamBuilder<QuerySnapshot>(
    stream: _firestore.collection('messegesMovies').orderBy('time').snapshots(),
